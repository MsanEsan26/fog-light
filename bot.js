...
client.ayarlar = { 
"token": "ODExNDc5OTczMTc2OTM0NDEx.YCyzng.JJvKefwApwjfPXKeC-UzpVkrzEM",
"prefix": "f!",
"sahip": "406334579272843264",
}
...
if(est) {
message.channel.send(new Discord.MessageEmbed().setThumbnail(mention.user.avatarURL() ? mention.user.avatarURL({dynamic: true}) : 'https://cdn.discordapp.com/attachments/810798391554342955/811481095161511986/botlogopng.png')
...
log.send(new Discord.MessageEmbed()
.setTitle('Fog Light - TAG Çıkarıldı.')
.setColor('#f1c335')
...
client.on('guildMemberRemove', async member => {
  ...
  let sayı = Number(sistemSayı);
  if(!sayı) return;
  const attachment = new Discord.MessageAttachment('https://cdn.discordapp.com/attachments/810798391554342955/811486578252972062/ezgif-6-4afe45d21982.gif');
